    ...
    <section class="posts container">
        ...
        <article class="post">            
            ...
            @endif
                ...
                {{--<div class="gallery-photos" data-masonry='{ "itemSelector": ".grid-item", "columnWdith": 464 }'>
                <figure class="grid-item grid-item--height2">
                    <img src="img/img-post-gallery-1.png" alt="" class="img-responsive">
                </figure>

                <figure class="grid-item grid-item--height2">
                    <img src="img/img-post-gallery-3.png" alt="" class="img-responsive">
                </figure>

                <figure class="grid-item grid-item--height2">
                    <img src="img/img-post-gallery-2.png" alt="" class="img-responsive">
                </figure>

                <figure class="grid-item grid-item--height2">
                    <img src="img/img-post-gallery-hover.png" alt="" class="img-responsive">
                </figure>
                </div>--}}
